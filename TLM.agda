...
... | cons-l v₁ v₂ = run-step p (update-env r v (cons v₁ v₂)) b
...
... | (cons v₁ v₂) = run-step p (update-env r v′ v₁) b
...
run-step p r (block-seq (instr-cons-upd {τ} v₀ v₁ v′ s) b) = run-step p (update-env r v′
